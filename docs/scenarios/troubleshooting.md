...
**Reference:** [#30](https://github.com/bradygaster/squad-pr/issues/30)
...
**Problem:** `squad` fails with an engine compatibility error, or Squad behaves unexpectedly.
